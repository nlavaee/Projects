...
class Autoencoder(nn.Module):
    def __init__(self, repr_dim):
        ...
        #padding is zero right now is that okay
    ...
    def init_weights(self):
        ...
        for fc in [self.fc1, self.fc2, self.fc3]:
            ...
            nn.init.normal_(fc.weight, 0.0, 0.1/sqrt(F_in))
            nn.init.constant_(fc.bias, 0.01)
        #
        #param_in = self.deconv.weight.size()

        nn.init.normal_(self.deconv.weight, 0.0, .01)
        nn.init.constant_(self.deconv.bias, 0.00)
    ...
    def decoder(self, encoded):
        ...
        #print("the shape of fc3, ", x.shape)
